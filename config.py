...
# List of ICA components to remove
ICA_EXCLUDE_MAP = {
    "001": [0, 3, 4, 5, 6],
    "002": [1, 5, 6, 10, 21],
    "003": [0, 1],
...
# Corrugator Supercilii, EXG7 (Highest tonic activity)
EMG_CS_CH = "EXG7" 

# EMG High-pass filter frequency for isolating muscle spikes
EMG_HPF = 20.0

# Event codes from file.tsv
EVENT_ID = {
    "random": 3,
    "symmetry": 1,
}
...
# Channels of interest for ERP plot
